...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT(
    ...
    KC_LCTL  , KC_LGUI  , KC_LALT  ,LSFT_T(KC_LANG2),LT(1,KC_SPC),LT(3,KC_LANG1),     KC_BSPC,LT(2,KC_ENT),                                KC_RSFT
  ),
  ...
  [3] = LAYOUT(
    ...
    RESET    , KBC_RST  , _______  , _______  , _______  , _______  ,                 _______ ,  _______  ,                               RESET
  ),
};
// clang-format on
